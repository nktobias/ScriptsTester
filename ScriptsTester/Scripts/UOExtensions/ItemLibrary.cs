  ...
  public class ItemLibrary
  {
    ...
    public static List<IUOItemType> PlayerSummons
    {
      get
      {
        ...
        summi.Add(new UOItemType() { Graphic = 0x001A, Color = 0x0835, Name = "wraith" });//wraith
        summi.Add(new UOItemType() { Graphic = 0x0003, Color = 0x0835, Name = "mummy" });//mummy
        summi.Add(new UOItemType() { Graphic = 0x0003, Color = 0x058D, Name = "ghoul" });//ghoul
        summi.Add(new UOItemType() { Graphic = 0x0003, Color = 0x049C, Name = "magic golem" });//ghoul
        ...
        summi.Add(new UOItemType() { Graphic = 0x000D, Color = 0x0000, Name = "air elemental" });//eartelemental
    ...
    //public static UOItemTypeCollection PlayerSummons
    //{
    //  get
    //  {
    //    UOItemTypeCollection items = new UOItemTypeCollection();
    ...
    //    //Serial: 0x000100FE  Name: "Uther"  Position: 5660.1828.- 30  Flags: 0x0000  Color: 0x0966  Model: 0x0027  Renamable: False Notoriety: Murderer HP: 130 / 130
    //    return items;
    //  }
    //}
    ...
    public static UOItemTypeCollection PlayerKlamaci
    {
      get
      {
        ...
        items.Add(new UOItemType() { Graphic = 0x00D8, Color = 0x0000, Name = "Cow" });//0x00E7  
        items.Add(new UOItemType() { Graphic = 0x00E7, Color = 0x0000, Name = "Cow Brow" });
        ...
        items.Add(new UOItemType() { Graphic = 0x001D, Color = 0x0000, Name = "Gorrila" });
        items.Add(new UOItemType() { Graphic = 0x00D8, Color = 0x0000, Name = "Cow black" });
    ...
    public static UOItemTypeCollection MountTypes
    {
      get
      {
       ...
       // Color: 0x0966  Graphic: 0x2135
   //     items.Add(new UOItemType() { Graphic = 0x00DF, Color = 0x0000, Name = "Orn" });TODO
