...
namespace CalExtension
{
  public class PlayerExtended
  {
    ...
    //---------------------------------------------------------------------------------------------
    public Serial Mount = Serial.Invalid;
    private Serial underMount = Serial.Invalid;
    private string youSeeMountText;
    ...
    [Executable("UseMount")]
    [BlockMultipleExecutions]
    public static void ExecUseMount(int timeout)
    {
      Game.CurrentGame.CurrentPlayer.UseMount(timeout);
    }
