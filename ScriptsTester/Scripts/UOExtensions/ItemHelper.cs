...
namespace CalExtension.UOExtensions
{
  public class ItemHelper
  {
    ...
    public static List<Graphic> CloseDoors { get { return new List<Graphic> { 0x06AD, 0x06A5, 0x0677, 0x0675, 0x067D, 0x06A5, 0x083B, 0x0839, 0x0695, 0x086E }; } }
    public static List<Graphic> OpenDoors { get { return new List<Graphic> { 0x06AE, 0x06A6, 0x0678, 0x0676, 0x067E, 0x06A6, 0x083C, 0x083A, 0x0696, 0x086F }; } }
    ...
    {
      return item.Graphic == 0x09B0  || item.Graphic == 0x0E76 || item.Graphic == 0x0E75 || item.Graphic == 0x0E77 || item.Graphic == 0x0E78 || item.Graphic == 0x0E79 || item.Graphic == 0x0E7D;
    }
    ...
    public static void luxing(int wait)
    {
      ...
      foreach (UOItem item in items)
      {
        ...
        item.Move(65000, World.Player.Backpack);
        Game.Wait(wait);
      }
    }
...
//19:32 You see: a +16 Bardiche of Vanquishing of
    ...
    //  ,exec SortLootTo "Vanquishing" "Invulnerability" "Paladin" "Cleric" "Warrior" "Grandmaster" "Ranger" "Phoenix" "Power" "+9" "+25"
